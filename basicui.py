...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bolusBar = QtWidgets.QProgressBar(self.RecurringTab)
        self.bolusBar.setGeometry(QtCore.QRect(120, 270, 331, 31))
        self.bolusBar.setProperty("value", 24)
        self.bolusBar.setObjectName("bolusBar")
