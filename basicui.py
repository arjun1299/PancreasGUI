...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.finishPrimeBtn.setGeometry(QtCore.QRect(80, 380, 141, 81))
        ...
        self.resetBtn.setGeometry(QtCore.QRect(380, 380, 151, 81))
        ...
        self.deliveryAmtLbl.setGeometry(QtCore.QRect(390, 46, 131, 51))
        ...
        self.pulseDelayLbl.setGeometry(QtCore.QRect(250, 40, 131, 61))
        ...
        self.doseTxt = QtWidgets.QLineEdit(self.RecurringTab)
        self.doseTxt.setGeometry(QtCore.QRect(330, 50, 113, 25))
        self.doseTxt.setObjectName("doseTxt")
        self.deliveryAmtTxt = QtWidgets.QLineEdit(self.RecurringTab)
        self.deliveryAmtTxt.setGeometry(QtCore.QRect(390, 110, 131, 31))
        self.deliveryAmtTxt.setObjectName("deliveryAmtTxt")
        self.pulseDelayTxt = QtWidgets.QLineEdit(self.RecurringTab)
        self.pulseDelayTxt.setGeometry(QtCore.QRect(250, 110, 113, 31))
        self.pulseDelayTxt.setObjectName("pulseDelayTxt")
        self.basalProfileBtn = QtWidgets.QPushButton(self.RecurringTab)
        self.basalProfileBtn.setGeometry(QtCore.QRect(330, 150, 89, 25))
        self.basalProfileBtn.setObjectName("basalProfileBtn")
        self.profileFrame = QtWidgets.QWidget(self.RecurringTab)
        self.profileFrame.setGeometry(QtCore.QRect(0, -10, 591, 521))
        self.profileFrame.setAutoFillBackground(True)
        self.profileFrame.setObjectName("profileFrame")
        self.profileRate_1 = QtWidgets.QLineEdit(self.profileFrame)
        self.profileRate_1.setGeometry(QtCore.QRect(200, 50, 113, 25))
        self.profileRate_1.setObjectName("profileRate_1")
        self.timeEdit_1 = QtWidgets.QTimeEdit(self.profileFrame)
        self.timeEdit_1.setGeometry(QtCore.QRect(60, 50, 118, 26))
        self.timeEdit_1.setObjectName("timeEdit_1")
        self.setProfileBtn = QtWidgets.QPushButton(self.profileFrame)
        self.setProfileBtn.setGeometry(QtCore.QRect(140, 470, 89, 25))
        self.setProfileBtn.setObjectName("setProfileBtn")
        self.timeEdit_2 = QtWidgets.QTimeEdit(self.profileFrame)
        self.timeEdit_2.setGeometry(QtCore.QRect(60, 100, 118, 26))
        self.timeEdit_2.setObjectName("timeEdit_2")
        self.profileRate_2 = QtWidgets.QLineEdit(self.profileFrame)
        self.profileRate_2.setGeometry(QtCore.QRect(200, 100, 113, 25))
        self.profileRate_2.setObjectName("profileRate_2")
        self.timeEdit_3 = QtWidgets.QTimeEdit(self.profileFrame)
        self.timeEdit_3.setGeometry(QtCore.QRect(60, 150, 118, 26))
        self.timeEdit_3.setObjectName("timeEdit_3")
        self.profileRate_3 = QtWidgets.QLineEdit(self.profileFrame)
        self.profileRate_3.setGeometry(QtCore.QRect(200, 150, 113, 25))
        self.profileRate_3.setObjectName("profileRate_3")
        self.timeEdit_4 = QtWidgets.QTimeEdit(self.profileFrame)
        self.timeEdit_4.setGeometry(QtCore.QRect(60, 200, 118, 26))
        self.timeEdit_4.setObjectName("timeEdit_4")
        self.profileRate_4 = QtWidgets.QLineEdit(self.profileFrame)
        self.profileRate_4.setGeometry(QtCore.QRect(200, 200, 113, 25))
        self.profileRate_4.setObjectName("profileRate_4")
        self.timeEdit_5 = QtWidgets.QTimeEdit(self.profileFrame)
        self.timeEdit_5.setGeometry(QtCore.QRect(60, 250, 118, 26))
        self.timeEdit_5.setObjectName("timeEdit_5")
        self.profileRate_5 = QtWidgets.QLineEdit(self.profileFrame)
        self.profileRate_5.setGeometry(QtCore.QRect(200, 250, 113, 25))
        self.profileRate_5.setObjectName("profileRate_5")
        self.profileRate_6 = QtWidgets.QLineEdit(self.profileFrame)
        self.profileRate_6.setGeometry(QtCore.QRect(200, 300, 113, 25))
        self.profileRate_6.setObjectName("profileRate_6")
        self.timeEdit_6 = QtWidgets.QTimeEdit(self.profileFrame)
        self.timeEdit_6.setGeometry(QtCore.QRect(60, 300, 118, 26))
        ...
        self.stopAllBtn.setStyleSheet("background-color: rgb(204, 0, 0)")
        ...
        self.basalPauseLbl = QtWidgets.QLabel(self.centralwidget)
        self.basalPauseLbl.setGeometry(QtCore.QRect(870, 90, 131, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.basalPauseLbl.setFont(font)
        self.basalPauseLbl.setStyleSheet("background-color: rgb(204, 0, 0)")
        self.basalPauseLbl.setObjectName("basalPauseLbl")
        self.timeDisplayLbl = QtWidgets.QLabel(self.centralwidget)
        self.timeDisplayLbl.setGeometry(QtCore.QRect(860, 10, 151, 41))
        self.timeDisplayLbl.setObjectName("timeDisplayLbl")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.resetBtn.setText(_translate("MainWindow", "Reverse and Reset"))
        ...
        self.basalProfileBtn.setText(_translate("MainWindow", "Profile"))
        self.setProfileBtn.setText(_translate("MainWindow", "Apply"))
        ...
        self.basalPauseLbl.setText(_translate("MainWindow", "Basal is paused"))
        self.timeDisplayLbl.setText(_translate("MainWindow", "00:00"))
